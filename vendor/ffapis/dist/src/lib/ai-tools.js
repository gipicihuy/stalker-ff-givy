...
exports.freefireTools = void 0;
exports.getToolByName = getToolByName;
exports.getToolNames = getToolNames;
exports.freefireTools = [
    {
        type: 'function',
        function: {
            name: 'search_player',
...
function getToolByName(name) {
    return exports.freefireTools.find(t => t.function.name === name);
}
function getToolNames() {
    return exports.freefireTools.map(t => t.function.name);
}
